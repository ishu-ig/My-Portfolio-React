...
import resumeValidator from "../../FormValidators/resumeValidator";
import { createAbout, getAbout } from "../../Redux/ActionCreators/AboutActionCreators";

const checklist = [
  { dot: "bg-primary", title: "Personal Info",    body: "Fill in your name, heading, and subtitle." },
  { dot: "bg-success", title: "Upload Files",     body: "Add a profile image and optionally your resume (PDF)." },
  { dot: "bg-warning", title: "Contact Details",  body: "Phone and email are required fields." },
];
...
export default function AdminCreateAbout() {
  ...
  const [error, setError] = useState({
    ...
    heading:          "Heading Field is Mandatory",
    subtitle:         "Subtitle Field is Mandatory",
  ...
  function getInputData(e) {
    ...
    // FIX: use imageValidator for pic, resumeValidator for resume
        ...
        <div className="page-heading">
          <div className="page-heading-copy">
            ...
            <div>
              ...
              <h1 className="h3 mb-1">Add About</h1>
              <p className="text-muted mb-0">Create a new About profile entry.</p>
            </div>
          </div>
            ...
            <div className="panel">
              <div className="panel-header">
                <div>
                  ...
                  <p className="text-muted mb-0">Fill in the details to create a new About entry.</p>
                </div>
              </div>
              ...
              <div className="row g-3">
                ...
                <div className="col-md-6">
                  <label className="form-label" htmlFor="pic">Profile Image</label>
                ...
                <div className="col-md-6">
                  <label className="form-label" htmlFor="resume">Resume <span className="text-muted fw-normal">(optional — PDF)</span></label>
              ...
              <div className="d-flex flex-wrap justify-content-end gap-2 mt-4">
                ...
                <button className="btn btn-primary" type="button" onClick={postSubmit}>
                  <i className="bi bi-check-circle" aria-hidden="true"></i> Create About
                </button>
              </div>
            </div>
          </div>
