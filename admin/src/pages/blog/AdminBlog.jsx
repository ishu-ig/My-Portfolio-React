...
export default function AdminBlog() {
  ...
  const totalCount    = BlogStateData ? BlogStateData.length : 0;
  const activeCount   = BlogStateData ? BlogStateData.filter((i) => i.active).length : 0;
  const inactiveCount = BlogStateData ? BlogStateData.filter((i) => !i.active).length : 0;

  const filteredData = BlogStateData
    ? BlogStateData.filter(
        (item) =>
          ...
          <div className="page-heading">
            ...
            <div className="heading-actions">
              <Link className="btn btn-primary btn-sm" to="/blog/create">
                <i className="bi bi-plus-circle" aria-hidden="true"></i> Add Blog
              </Link>
            </div>
          </div>

          {/* Metric Cards */}
          <section className="row g-3 mt-2 mb-1" aria-label="Blog summary">
            <div className="col-12 col-sm-6 col-xl-4">
              <article className="metric-card text-white">
                <div className="metric-top">
                  <span className="metric-label">Total</span>
                  <span className="metric-icon"><i className="bi bi-journal-text"></i></span>
                </div>
          ...
          <section className="panel mt-3">
            <div className="panel-header">
              <div>
                ...
                <p className="text-muted mb-0">
                  Search, review, and manage blog posts.
                </p>
              </div>
            ...
            <div className="table-responsive">
              <table className="table align-middle mb-0" id="blogsTable">
                <thead>
                  <tr>
                    <th scope="col">#</th>
